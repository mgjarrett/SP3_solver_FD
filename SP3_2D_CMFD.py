...
if __name__ == '__main__':
    ...
    if(case == "takeda_2D"):
        ...
        #f = open(matfile,"w")
        nfuelx=nx*3/6 ### reflector on east
        nfuely=ny ### reflector on north
        nfuelz=nz*3/6 ### reflector on top
        nreflx=nx
        nrefly=ny 
        nreflz=nz
    ...
    if(case == "takeda_2D"):
        ...
        nfuelx=nxc*3/6 ### reflector on east
        nfuely=nyc ### reflector on north
        nfuelz=nzc*3/6 ### reflector on top
        nreflx=nxc
        nrefly=nyc
        nreflz=nzc
